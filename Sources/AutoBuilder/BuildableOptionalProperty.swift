...
///
/// When `Wrapped` conforms to `Buildable` (any type with `@Buildable` attached to it conforms to
/// `Buildable`), `BuildableOptionalProperty` will store an instance of `Wrapped.Builder` as
/// its sub-builder.
///
/// - SeeAlso:
///   - `BuildableProperty`
...
public class BuildableOptionalProperty<Wrapped> {
    ...
    /// The builder of type `Wrapped.Builder`. The client's property will be initialized to the value
    ...
    /// and the resulting builder will be used as this `BuildableOptionalProperty`'s sub-builder.
    ...
    /// - Returns: The value that the client's property should be initialized to.
    /// - Throws: If `Wrapped` conforms to `Buildable`, this method will throw any errors
    /// thrown by `Wrapped.Builder.build()`.
    ///
    /// If `Wrapped` conforms to `Buildable`, then the value returned by this method will be
    /// the result of calling the sub-builder's `build()` method.
...
extension BuildableOptionalProperty where Wrapped: Buildable {
    ...
    ///
    /// Calling `get` will return the existing sub-builder. If no sub-builder already exists, then a new sub-builder will
    /// be created for this `BuildableOptionalProperty` and the new sub-builder will be returned.
    ///
