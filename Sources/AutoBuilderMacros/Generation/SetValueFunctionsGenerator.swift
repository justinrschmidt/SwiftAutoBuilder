...
///
/// Every property in the builder's client needs to have a set value function in the builder class. Arrays,
/// dictionaries, and sets have additional methods that make them easier to work with. These functions are collectively
/// known as the "set value functions". `SetValueFuctionsGenerator` contains the methods that generate all of those set
/// value functions.
struct SetValueFunctionsGenerator {
    static func createSetValueFunctions(
        identifierPattern: IdentifierPatternSyntax,
        variableType: VariableType,
        returnType: TypeSyntaxProtocol
        ...
        case let .array(elementType):
            return [
                ...
                try createAppendElementFunction(
                    identifierPattern: identifierPattern,
                    elementType: elementType,
                    returnType: returnType),
                try createAppendCollectionFunction(
                    identifierPattern: identifierPattern,
                    elementType: elementType,
                    returnType: returnType),
        ...
        case let .dictionary(keyType, valueType):
            return [
                try createSetValueFunction(identifierPattern: identifierPattern, type: type, returnType: returnType),
                try createInsertDictionaryFunction(
                    identifierPattern: identifierPattern,
                    keyType: keyType,
                    valueType: valueType,
                    returnType: returnType),
                try createMergeDictionaryFunction(
                    identifierPattern: identifierPattern,
                    keyType: keyType,
                    valueType: valueType,
                    returnType: returnType),
        ...
        case let .set(elementType):
            return [
                try createSetValueFunction(identifierPattern: identifierPattern, type: type, returnType: returnType),
                try createInsertSetFunction(
                    identifierPattern: identifierPattern,
                    elementType: elementType,
                    returnType: returnType),
                try createFormUnionSetFunction(
                    identifierPattern: identifierPattern,
                    elementType: elementType,
                    returnType: returnType),
                try createRemoveAllFunction(identifierPattern: identifierPattern, returnType: returnType)
        ...
        case let .optional(wrappedType):
            return [
                try createSetValueFunction(
                    identifierPattern: identifierPattern,
                    type: OptionalTypeSyntax(wrappedType: wrappedType),
                    returnType: returnType)
            ]
    ...
    private static func createSetValueFunction(
        identifierPattern: IdentifierPatternSyntax,
    ...
    private static func createAppendElementFunction(
        identifierPattern: IdentifierPatternSyntax,
    ...
    private static func createAppendCollectionFunction(
        identifierPattern: IdentifierPatternSyntax,
        elementType: TypeSyntax,
        returnType: TypeSyntaxProtocol
    ) throws -> FunctionDeclSyntax {
    ...
    private static func createInsertDictionaryFunction(
        identifierPattern: IdentifierPatternSyntax,
        keyType: TypeSyntax,
    ...
    private static func createMergeDictionaryFunction(
        identifierPattern: IdentifierPatternSyntax,
        keyType: TypeSyntax,
        valueType: TypeSyntax,
        returnType: TypeSyntaxProtocol
    ...
    private static func createInsertSetFunction(
        identifierPattern: IdentifierPatternSyntax,
        elementType: TypeSyntax,
        returnType: TypeSyntaxProtocol
    ) throws -> FunctionDeclSyntax {
    ...
    private static func createFormUnionSetFunction(
        identifierPattern: IdentifierPatternSyntax,
        elementType: TypeSyntax,
        returnType: TypeSyntaxProtocol
    ) throws -> FunctionDeclSyntax {
    ...
    private static func createRemoveAllFunction(
        identifierPattern: IdentifierPatternSyntax,
        returnType: TypeSyntaxProtocol
    ) throws -> FunctionDeclSyntax {
